    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <span className="whitespace-nowrap">{t("clients.title")}</span>
          <span className="w-12 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full"></span>
        </h2>

        <div
          className="bg-gradient-to-br from-slate-800/70 via-slate-900/80 to-slate-800/70 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 shadow-xl text-center"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          <p className="text-slate-300 text-base leading-relaxed mb-10 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {clients.map((client, i) => (
              ...
              >
                ...
                <div className="relative z-10 w-16 h-16 mb-2 p-2 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-lg shadow-inner group-hover:scale-110 transition-transform duration-300">
                  <img
                    src={client.logo}
                    alt={client.name}
                ...
                <span className="relative z-10 text-xs font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300 group-hover:from-cyan-200 group-hover:to-blue-200 transition-all duration-300">
                  {client.name}
                </span>
              </div>
            ))}
